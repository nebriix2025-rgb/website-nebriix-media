      ...
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between gap-6 px-5 sm:px-8">
        <Link href="/" className="relative z-10 shrink-0" aria-label={site.name}>
          <Image
            ...
            width={110}
            height={47}
            // `priority` is deprecated in Next 16; eager + high fetchPriority
            // is the replacement for above-the-fold images.
            loading="eager"
            fetchPriority="high"
        ...
        <div className="flex items-center gap-2">
          ...
          <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent side="right" className="w-full border-border sm:w-80">
